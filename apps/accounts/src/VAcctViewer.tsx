...
export const VAcctViewer = observer(function VAcctViewer({ vacct }: { vacct: ledger.ValidatedRawSheetAccount }) {

  const { lines, origin, ...withoutLines } = vacct;

  const isasset = vacct.settings.accounttype !== 'cash' && vacct.settings.accounttype !== 'futures-cash';
