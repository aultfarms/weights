...
import { assertAccount, assertInventoryAccount, assertLivestockInventoryAccount, } from './types.js';
...
export default function ({ accts, status }) {
    ...
    for (const acct of accts) {
        ...
        try {
            ...
            let latestReasonableDate = null;
            let latestReasonableDateLineno = null;
            for (const l of acct.lines) {
                ...
                if (!l.date)
                    throw new LineError({ line: l, msg: `Line has no date` });
...
//# sourceMappingURL=assertAllAccounts.js.map